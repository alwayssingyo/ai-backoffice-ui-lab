...
export const Route = createFileRoute("/(project)/project/(board)/board/(notice)/notice/")({
...
function RouteComponent() {
	...
	return <BoardManagementScreen routeConfig={BOARD_ROUTE_CONFIG_MAP.notice} search={search} />;
}
